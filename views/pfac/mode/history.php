    ...
    <div class="historyInputDiv" align="center">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><input type="text" name="pfac_history_reqired[clubs]" 
                			value="<?php echo (isset($_SESSION['pfac_history_reqired']['clubs'])) ? trim($_SESSION['pfac_history_reqired']['clubs']) : trim("");?>" 
            ...
            <tr>                                       
                ...
                <td><input type="text" name="pfac_history_reqired[appearances]" 
                			value="<?php echo (isset($_SESSION['pfac_history_reqired']['appearances'])) ? trim($_SESSION['pfac_history_reqired']['appearances']) : trim("");?>" 
                			class="inputs <?php echo (array_key_exists("appearances", $_SESSION['pfac_reqired_errors'])) ? "errorsIndicatedFields" : trim(""); ?>" /></td>
            </tr>   
                <td><span class="defaultFont">Goals&nbsp;&nbsp;&nbsp;</span><span class="defaultFont webRequiredIndicator">*&nbsp;</span></td>                        
                <td><input type="text" name="pfac_history_non_reqired[goals]" 
                			value="<?php echo (isset($_SESSION['pfac_history_non_reqired']['goals'])) ? trim($_SESSION['pfac_history_non_reqired']['goals']) : trim("");?>" 
                    		class="inputs" /></td>
            </tr>
            ...
            <tr>            	
                ...
                <input type="submit" name="pfac_history_submit" 
    ...
    <div class="historyRecordsDisplayDiv" align="center">
        ...
        <?php if ((!empty($_SESSION['pfac_session_data'])) || (isset($fullDetails))):?>
            <tr>
                ...
                <th width="400"><span class="defaultFont">Club</span></th>
