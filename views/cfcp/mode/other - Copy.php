    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="pfac_fields_table">
        ...
        <tr>
            ...
            <td>
				...
				?>
                <div class="bc-wrap"><div class="bc-input-d"><input id="txt-bc" readonly="readonly" class="inputs <?php echo ((isset($_SESSION['cfcp_reqired_errors'])) && ($_SESSION['cfcp_reqired_errors'] == "birth_certificate")) ? "errorsIndicatedFields" : ""; ?>" type="text"  value="<?php echo $bc_name_real;?>" style="width:164px;" /></div><div title="Browse birth certificate" class="queue-file-bc"><input type="file" name="file-bc" class="hide-file" id="file-bc" /></div></div>
			</td>
        </tr>
        <tr>
        	<td colspan="3">
        ...
        <tr>
            ...
            <td>
				...
				?>
                <div class="reg-wrap"><div class="reg-input-d"><input id="txt-reg" readonly="readonly" class="inputs <?php echo ((isset($_SESSION['cfcp_reqired_errors'])) && ($_SESSION['cfcp_reqired_errors'] == "birth_certificate")) ? "errorsIndicatedFields" : ""; ?>" type="text"  value="<?php echo $reg_name_real;?>" style="width:164px;" /></div><div title="Browse registration card" class="queue-file-reg"><input type="file" name="file-reg" class="hide-file" id="file-reg" /></div></div>
            </td>
        </tr>
        <tr>
	        <td colspan="3">
