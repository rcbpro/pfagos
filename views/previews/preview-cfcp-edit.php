...
<?php
		if(
		   (empty($preview_details_in_cfcp[0]['position'])) ||
		   (empty($preview_details_in_cfcp[0]['place_of_birth'])) ||
		   (empty($preview_details_in_cfcp[0]['height'])) ||
		   (empty($preview_details_in_cfcp[0]['weight'])) ||
		   (empty($history)) ||
		   ((empty($preview_details_in_cfcp[0]['photo_url'])) && (empty($_SESSION['cfcp_preview_img'])))
		   )
		{
			echo '<div id="pre-er">';
			...
			//General
			$ary_general = array(
				 "Position" => $preview_details_in_cfcp[0]['position'], 
				 "Place of birth" => $preview_details_in_cfcp[0]['place_of_birth'], 
				 "Height" => $preview_details_in_cfcp[0]['height'],
				 "Weight" => $preview_details_in_cfcp[0]['weight']
				 );
			...
			*/
			...
			$message_media = "";
			if (empty($preview_details_in_cfcp[0]['photo_url']) && empty($_SESSION['cfcp_preview_img'])){
                        ...
                        <tr>
                            ...
                            <td class="info-white-text"><?php 
															if (isset($_SESSION['cfcp_senior_non_reqired']['birth_place'])){
																...
																echo $preview_details_in_cfcp[0]['place_of_birth'];
															}else{
																echo "";
															}
															?></td>
